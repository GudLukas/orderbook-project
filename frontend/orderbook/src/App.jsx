import ApiTest from './components/ApiTest(Not_Used).jsx'
        ...
        <div className="relative z-10 text-center py-16 px-8">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
              Advanced real-time order management system with professional-grade analytics and lightning-fast execution
            </p>
        ...
        <div className="max-w-6xl mx-auto px-8">
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl p-8 md:p-12 text-center shadow-2xl">
            ...
            <p className="text-lg text-gray-300 mb-8 max-w-2xl mx-auto">
              Experience next-generation order book visualization with real-time market depth analysis, 
              advanced charting capabilities, and institutional-grade trading tools.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
              ...
              <div className="bg-white/5 rounded-xl p-6 border border-white/10">
                <div className="text-2xl font-bold text-blue-400 mb-2">&lt;1ms</div>
